...
library("DECIPHER")
```
```{r, out.width = "100px", fig.cap="Basenji (S)"}

knitr::include_graphics("dog/Basenji.jpg")
```
```{r, out.width = "200px", fig.cap="Boxer (L)"}
knitr::include_graphics("dog/Boxer.jpg")


```
```{r, out.width = "200px", fig.cap="Great Dane (XL)"}
knitr::include_graphics("dog/greatdane.jpg")


``` 
```{r, out.width = "1000px", fig.cap="Golden Retriever (L)"}

knitr::include_graphics("dog/labret.jpg")

```
```{r, fig.cap="German Shepherd (L)"}
