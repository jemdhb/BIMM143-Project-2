...
```{r, out.width = "200px", echo=F}
knitr::include_graphics(c("small coll.png","large coll.png"))
```
```{r}
#expression data 
...
p<-ggplot(data = expression, mapping = aes_string(x="norm_exp",y="weight_kg" ,col= "size"))+geom_point(size=4,alpha=0.6)
p+scale_color_manual(values=myColors)
```
