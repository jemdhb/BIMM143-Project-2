...
# pie chart instead of scatter plor for dist 

pies<-read_excel("dog snps.xlsx",sheet="pie")
pie(pies$lcorl,labels=pies$Name,col=myColors)
...
```{r}
pies<-read_excel("dog snps.xlsx",sheet="pie")
pie(pies$igf1,labels=pies$Name,col=myColors)
