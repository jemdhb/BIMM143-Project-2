...
```{r, echo=F}
knitr::include_graphics("dog/msa_breeds.jpg")
```
...
#fasta data for each dog breeds SNP +/- 5 bp. "fasta/LCORL_names.txt": contains the 
...
alignment<-mult_alignments("fasta/LCORL_file.txt","fasta/LCORL_names.txt","LCORL")
...
#fasta file containing the LCORL SNP +/- 5 bp for our our 6 dogs. LCORL_names.txt 
...
create_dendrogram("fasta/LCORL_file.txt", "fasta/LCORL_names.txt", "LCORL Extended Fragment Dendrogram")
```
...
knitr::include_graphics("dog/expression_breeds_1.png")
```


```{r, out.width="400px",echo=F}
knitr::include_graphics("dog/expression_breeds_2.png")
```
